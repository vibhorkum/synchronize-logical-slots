 ...
 *
 * slot_timelines.c
 *              this code for slot timeline following
 *
...
PG_FUNCTION_INFO_V1(pg_create_logical_slot_timelines);
PG_FUNCTION_INFO_V1(pg_advance_logical_slot_timelines);
 ...
 */
Datum
pg_create_logical_slot_timelines(PG_FUNCTION_ARGS)
{
     ...
     * pg_advance_logical_slot_timelines .
     */
 ...
 */
Datum
pg_advance_logical_slot_timelines(PG_FUNCTION_ARGS)
{
    char       *slotname = text_to_cstring(PG_GETARG_TEXT_P(0));
